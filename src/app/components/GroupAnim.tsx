...
export default function CombinedAnim({ className, svgSize = 700 }: Props) {
  ...
  const baseSize = 700; // The original SVG size
  const scale = svgSize / baseSize;

  const circleRadius = 250 * scale;
